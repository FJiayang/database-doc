 ...
 */
@Component
public class PbocDatabaseHandler implements DatabaseHandler {
    ...
    public String getDatabaseName() {
        return DatabaseEnums.PBOC.getName();
    }
    ...
    public DataSource getDataSource() {
        ...
        hikariConfig.setJdbcUrl(properties.getAddress()+DatabaseEnums.PBOC.getName());
