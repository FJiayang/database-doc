 ...
 */
@Component
public class NlsDatabaseHandler implements DatabaseHandler {
    ...
    public String getDatabaseName() {
        return DatabaseEnums.NLS.getName();
    }
    ...
    public DataSource getDataSource() {
        ...
        hikariConfig.setJdbcUrl(properties.getAddress()+DatabaseEnums.NLS.getName());
