 ...
 */
@Component
public class RiskDatabaseHandler implements DatabaseHandler {
    ...
    public String getDatabaseName() {
        return DatabaseEnums.RISK.getName();
    }
    ...
    public DataSource getDataSource() {
        ...
        hikariConfig.setJdbcUrl(properties.getAddress()+DatabaseEnums.RISK.getName());
