 ...
 */
@Component
public class RuleDatabaseHandler implements DatabaseHandler {
    ...
    public String getDatabaseName() {
        return DatabaseEnums.RULE.getName();
    }
    ...
    public DataSource getDataSource() {
        ...
        hikariConfig.setJdbcUrl(properties.getAddress()+DatabaseEnums.RULE.getName());
